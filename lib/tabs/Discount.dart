  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CubitsHome, HomeState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          body: FutureBuilder(
            future:cubitvar.discount(widget.title, widget.doc),
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  if(basic['love']==true){
                                    ...
                                    WidgetsUi().reload(context, DetailsMenu(title: widget.title,doc: widget.doc,tab: 2,));
                                  }else{
